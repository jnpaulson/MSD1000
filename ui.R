...
shinyUI(navbarPage("MSD 1000",
  ...
  tags$hr(),tags$h3("Explore the data in the tabs above!"),p("We welcome you to explore the data on this site through the tabs above. Data was filtered (for server speed) at each level to include only bacteria present in over 20 samples. Additionally, only OTU sequences present in over 20 samples are shown."),
