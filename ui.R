...
shinyUI(navbarPage("MSD 1000",
  ...
  tabPanel("PCA",
    ...
    tabPanel("Heatmap",
      ...
      sidebarLayout(sidebarPanel(
        radioButtons("heatSamples","Samples to use:",c("Both"="Both","Cases"="Case","Controls"="Control"),selected="Controls"),
        ...
        radioButtons("heatColumns",
            "Column labels:",c("Health"="Type","Country"="Country","Age" = "AgeFactor","Dysentery"="Dysentery"),selected="Age"),
        br(),
        tags$small("Warning: takes a few seconds")
        ),
